-- A reviewer may correct imported source-page labels before publishing an edition.
-- The original source payload remains untouched in catalogue_import_queue and edition_sources.
