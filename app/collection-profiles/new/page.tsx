...
export default async function NewCollectionProfilePage({ searchParams }: NewCollectionProfilePageProps) {
  ...
  return <main className="review-page catalogue-page">
    <header className="site-header"><Link className="brand" href="/" aria-label="RAR Index home"><span className="brand-mark">R</span><span>RAR</span><em>Index</em></Link><Link className="header-note" href="/data-readiness">Back to readiness -&gt;</Link><StaffNav current="/collection-profiles" /></header>
